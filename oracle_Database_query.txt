...
 
ALTER TABLE COUNTRIES ADD (
  CONSTRAINT COUNTR_REG_FK FOREIGN KEY (REGION_ID) REFERENCES REGIONS (REGION_ID) ENABLE VALIDATE);
...
(
  ...
  CITY            VARCHAR2(30 BYTE) CONSTRAINT LOCATIONS NOT NULL,
...
 
CREATE INDEX JOB_ID_PK ON JOBS(JOB_ID);
 
...
(
  ...
  EMAIL           VARCHAR2(25 BYTE) CONSTRAINT EMP_EMAIL_NNNOT NULL,
...
ALTER TABLE EMPLOYEES ADD (
  ...
  CHECK (salary > 0)
  ENABLE VALIDATE,
  CONSTRAINT EMP_EMP_ID__PK
  PRIMARY KEY
  (EMPLOYEE_ID)
  USING INDEX EMP_EMP_ID_PK
  ENABLE VALIDATE,
  CONSTRAINT EMP_EMP_ID_EMAIL_UK
  UNIQUE (EMAIL)
...
(EMPLOYEE_ID);
 
CREATE UNIQUE INDEX JHIST_ST_DATE_PK ON JOB_HISTORY(EMPLOYEE_ID, START_DATE);
 
